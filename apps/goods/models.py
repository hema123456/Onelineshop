...
class Goods(models.Model):
    ...
    min_order = models.FloatField("最小起订量", default=0)
    min_unit_price = models.FloatField("最小单价", default=0)
    max_unit_price = models.FloatField("最大单价", default=0)
    unit = models.CharField("单位", choices=UNIT_TYPE, max_length=10, default='Pieces')
    pic_url = models.URLField("商品展示图url", default='')
    ali_url = models.URLField("商品阿里巴巴链接", default='')

    goods_sn = models.CharField("商品唯一货号", max_length=50, default="none")
    ...
    goods_brief = models.TextField("商品简短描述", max_length=500, default='none')
    goods_desc = UEditorField(verbose_name=u"商品详细描述", imagePath="goods/images/", width=1000, height=300,
                              filePath="goods/files/", default='none')
