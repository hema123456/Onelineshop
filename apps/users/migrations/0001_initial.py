    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[(0, '保留字段'), (1, '用户注册'), (2, '修改密码'), (3, '找回密码')], default='female', max_length=6, verbose_name='操作类型')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('expire', models.IntegerField(default=60, verbose_name='有效时间')),
            ],
            options={
                'verbose_name': '验证码',
